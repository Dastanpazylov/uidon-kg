        ...
        <div className="flex justify-around mt-[0.938rem]">
          <>
            <button
              ...
              className={`rounded-[0.625rem] w-[25rem] pt-[auto] pl-[1.5rem] pr-[1.5rem] h-[2.25rem] leaning-[1.524rem] font-[400] text-[#E8E8E8] text-[1.25rem] ${
                isRatingGiven ? 'bg-[#9747FF] cursor-pointer' : 'bg-[#9DB2BF] opacity-50 '
              }`}
...
export default ModalWindowCustomer;
